...
namespace bytme.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Products(string searchString, string currentFilter, string category, string maxPrice, string minPrice, string currentCategory, string currentBrands, IEnumerable<string> BrandBox, IEnumerable<string> ColorBox)
        {
