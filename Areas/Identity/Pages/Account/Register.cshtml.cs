    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new UserModel { dt_created = DateTime.Now, UserName = Input.Email, Email = Input.Email, street = Input.street, streetnumber = Input.streetnumber, city = Input.city, zipcode = Input.zipcode, name = Input.name, surname = Input.surname, points = -1};
